...
function TextureSelector({
    ...
    // Thumbnails disabled until API supports authentication
    ...
    // Load thumbnails for visible textures - DISABLED: API doesn't support authentication yet
    // useEffect(() => {
    ...
    // Cleanup blob URLs on unmount - DISABLED until API supports thumbnails
    // useEffect(() => {
    ...
    // Thumbnails disabled - API doesn't support authentication yet
